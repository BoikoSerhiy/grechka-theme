...
<div class="paginations <?php if($hide): ?>hide<?php endif; ?>">
	...
	<?php else: ?>
        <a class="btn prev" rel="prev" href="<?=get_pagenum_link($current - 1)?>"><span>Попередня</span></a>
	<?php endif; ?>
	...
	<?php else: ?>
        <a class="btn next" rel="next" href="<?=get_pagenum_link($current + 1)?>"><span>Наступна</span></a>
	<?php endif; ?>
